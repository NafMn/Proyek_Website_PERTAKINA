          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
              <div id="dataTable_filter" class="dataTables_filter">
                <form action="POST" action="search-data.php" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                  <div class="input-group">
                    <input type="text" class="form-control bg-light border-0 small" placeholder="Cari Course..." aria-label="Search" aria-describedby="basic-addon2" name="search_keyword" />
