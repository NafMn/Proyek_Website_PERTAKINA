...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  // Perbaikan pada query, tambahkan tanda kutip pada variabel $username dan $hashedPassword
...
<head>
  ...
  <title>Pertakina-Admin | Register</title>
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Buat Akun Admin Pertakina</h1>
              </div>
